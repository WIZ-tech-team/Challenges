...
<br>
        <div>
            ...
            <x-input-error :messages="$errors->updatePassword->get('password')" class="form-control" />
        </div>
        <br>
        <div>
            ...
            <x-input-error :messages="$errors->updatePassword->get('password_confirmation')" class="form-control" />
        </div>
      <br>
