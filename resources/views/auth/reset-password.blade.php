...
<html lang="en">
	...
	<body id="kt_body" class="auth-bg">
        ...
        <div>
            ...
            <x-text-input id="email" class="form-control bg-transparent" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="form-control bg-transparent" type="password" name="password" required autocomplete="new-password" />
        ...
        <div class="flex items-center justify-end mt-4">
            <x-primary-button style="background-color: #7E57C2; border-radius:10px" >
                {{ __('Reset Password') }}
            </x-primary-button>
        </div>
    </form></div></div>
